...
namespace GameOfLife
{
    class AdWindow : Window
    {
        ...
        private readonly ImageBrush[] _images;
        ...
        public AdWindow(Window owner)
        {
            ...
            _images = new[]
            {
                new ImageBrush{ImageSource = new BitmapImage(new Uri("ad1.jpg", UriKind.Relative))}, 
                new ImageBrush{ImageSource = new BitmapImage(new Uri("ad2.jpg", UriKind.Relative))}, 
                new ImageBrush{ImageSource = new BitmapImage(new Uri("ad3.jpg", UriKind.Relative))}
            };
